"""
<name>Sign Detect</name>
<description>Widget description</description>
<icon>icons/signdetect.png</icon>
...
class OWSignDetect(OWImgWidget):
    settingsList = ['method_id', 'auto_apply']

    def __init__(self, parent=None, signalManager=None):
        super(OWSignDetect, self).__init__(parent, signalManager)
        ...
        self.method = [("Hough Forest", self.forest),
                       ("Hough", self.forest)]
    ...
    def forest(self, data):
        ...
        io.imsave("/Users/michael/theimage.jpg", data)
        call("/Users/michael/run_detect.sh", shell=True )
        image = io.imread("/Users/michael/detect-0_sc0_c0.png")
        return image
